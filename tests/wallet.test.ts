...
describe('VoidCloud Multi-Wallet & 1AM Wallet Integration Unit Tests', () => {
  ...
  it('successfully binds 1AM Wallet with 5,000 tNIGHT and 587.28 tDUST sponsored balance', () => {
    const oneAmAddress = '1am_preprod1q9v4c3k2y9w8m7x6z5a4b3c2d1e0f';
    const wallet = createMockWalletState('1AM Wallet', oneAmAddress, 5000, 587.28);
    ...
    expect(wallet.balances.tDUST).toBe(587.28);
  ...
  it('properly resets balances on wallet disconnection', () => {
    let wallet = createMockWalletState('1AM Wallet', '1am_preprod1qtest', 5000, 587.28);
    expect(wallet.isConnected).toBe(true);
